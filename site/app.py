...
def download_folder(foldername):
    ...
    try:
        ...
        # Используем текущую директорию для совместимости с Termux
        ...
        response = send_file(zip_path, as_attachment=True, download_name=f"{foldername}.zip")
...
if __name__ == '__main__':
    ...
    print(f"Сервер будет доступен на:")
    print(f"  - http://localhost:8111")
    print(f"  - http://127.0.0.1:8111")
    print(f"  - http://192.168.0.211:8111 (замените на ваш IP)")
